...
### Schedule Counter (`/schedule-counter`)
...
**Google Apps Script Projects (Payroll, Manager Hub, Catering Quote, Shared Table Email):**
1. See the setup guide in each project folder
